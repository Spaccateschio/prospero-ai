-- RISORSE FINANZIARIE (Banca 1, Banca 2, Cassa Assegni, Cassa Contanti, ecc.)
...
-- Collega i movimenti (transactions) a una risorsa finanziaria specifica,
-- così il saldo di ogni banca/cassa si calcola sommando i movimenti collegati.
...
-- Stessa cosa per i pagamenti fattura registrati direttamente (senza movimento collegato in futuro)
