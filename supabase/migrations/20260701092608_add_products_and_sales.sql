-- CATALOGO PRODOTTI: anagrafica leggera, arricchita/derivata dai movimenti importati.
...
-- RIGHE VENDITA (scarichi di magazzino): un record per riga prodotto/cliente/data,
-- così possiamo calcolare prodotto più venduto, cliente che acquista di più,
-- prezzo medio di vendita mensile/settimanale.
...
-- Evita di duplicare le stesse righe se lo stesso export viene reimportato per errore.
